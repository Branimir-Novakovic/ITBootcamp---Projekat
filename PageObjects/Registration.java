...
public class Registration {
	...
	private static final String SAVEACCTINFOBTN = "//input[@name='newAccount']";
	...
	// Metode za objekat USER ID
		...
		public static Select getLanguage(WebDriver dr) {
			
			return new Select(dr.findElement(By.xpath(LANGUAGE)));
		}
		
		public static void enterLanguage(WebDriver dr, String text) {
			getLanguage(dr).selectByVisibleText(text);
		}
		
		public static Select getFavoriteCategory(WebDriver dr) {
			return new Select(dr.findElement(By.xpath(FAVORITE_CATEGORY)));
		}

		public static void inputFavoriteCategory(WebDriver dr, String text) {
			getFavoriteCategory(dr).selectByVisibleText(text);
		}

		public static WebElement getEnableMyList(WebDriver dr) {
			return dr.findElement(By.xpath(ENABLEMYLIST));
		}

		public static void clickEnableMyList(WebDriver dr) {
			getEnableMyList(dr).click();
		}

		public static WebElement getEnableMyBanner(WebDriver dr) {
			return dr.findElement(By.xpath(ENABLEMYBANNER));
		}

		public static void clickEnableMyBanner(WebDriver dr) {
			getEnableMyBanner(dr).click();
		}

		public static WebElement getSaveAcctInfo(WebDriver dr) {
			return dr.findElement(By.xpath(SAVEACCTINFOBTN));
		}
